...
const episodes = [
  ...
  { id: 3, title: "001", duration: "61m", description: "New players gather for a chance to win 45.6 billion won. After an intense first round, the survivors' fates hang in the balance — down to one final vote.", thumbnail: ep3, videoUrl: null },
  { id: 4, title: "Six Legs", duration: "62m", description: "The players prepare for the next game: a six-legged pentathlon, where each team member must clear a mini-game to survive — or face collective elimination.", thumbnail: ep4, videoUrl: null },
  { id: 5, title: "One More Game", duration: "76m", description: "Kang No-eul earns enemies for her unruly actions. Nerves fray to the breaking point as the remaining players vote on whether to move to the next round.", thumbnail: ep5, videoUrl: null },
  { id: 6, title: "O X", duration: "52m", description: "Jun-ho and his team prepare to infiltrate a suspicious island. As monetary stakes and tensions rise, players split into two opposing factions.", thumbnail: ep6, videoUrl: null },
  { id: 7, title: "Friend or Foe", duration: "60m", description: "The remaining players strategize on how to survive the night. Gi-hun proposes a risky plan — but he will need trustworthy allies to carry it out.", thumbnail: ep7, videoUrl: null },
];
